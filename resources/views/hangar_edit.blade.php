        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">
                    @lang('hangarmod.editAircraft')
                </h3>
            </div>
            <div class="block-content">
                <form action="{{route('edit.hangar.update', $hangar->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <tr>
                            <td>
                                <span class="fw-semibold"><label class="form-label"
                                                                 for="name">@lang('hangarmod.name')</label></span>
                            </td>
                            <td class="d-none d-xl-table-cell">
                                <span class="fs-sm text-muted"><input type="text" class="form-control"
                                                                      id="name" name="name"
                                                                      value="{{$hangar->name}}"></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <span class="fw-semibold"><label class="form-label"
                                                                 for="acftregistration">@lang('hangarmod.registration')</label></span>
                            </td>
                            <td class="d-none d-xl-table-cell">
                                <span class="fs-sm text-muted"><input type="text" class="form-control"
                                                                      id="acftregistration" name="acftregistration"
                                                                      maxlength="4" value="{{$hangar->acftregistration}}"></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <span class="fw-semibold"><label class="form-label"
                                                                 for="ICAOCode">@lang('hangarmod.aircraftmodel')</label></span>
                            </td>
                            <td class="d-none d-xl-table-cell">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="submit" class="btn btn-alt-primary" style="float: right;">
                                    <i class="fa fa-check-circle opacity-50 me-1"></i> @lang('hangarmod.save')
                                </button>
                            </td>
                        </tr>
                        </tbody>
