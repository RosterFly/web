...
('BV', 'Bouvet Island (Bouvetøya)', 'Bouvet Island (Bouvetøya)', 'AN'),
...
('GB', 'United Kingdom of Great Britain and Northern Ireland', 'United Kingdom of Great Britain & Northern Ireland', 'EU'),
...
('GR', 'Greece', 'Hellenic Republic of Greece', 'EU'),
...
('MK', 'North Macedonia', 'Republic of North Macedonia', 'EU'),
...
('SZ', 'Eswatini', 'Kingdom of Eswatini', 'AF'),
...
('XK', 'Kosovo', 'Republic of Kosovo', 'EU'),
('YE', 'Yemen', 'Yemen', 'AS'),
